...
int main(){
    ...
    if(buffer_get==48){
        ...
        unsigned long my_seed=time(NULL);
        loop2:
        buffer_cmd[35]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[36]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[37]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[38]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[39]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[40]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[41]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[42]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[43]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[44]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[45]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[46]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[47]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[48]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[49]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        buffer_cmd[50]=((my_seed=((my_seed*214013+2531011)>>16)&32767)%10)+48;
        FILE *file_popen=_popen(buffer_cmd,"rb");
        while((buffer_get=getc(file_popen))!=EOF){
            if(buffer_get==79){
                loop3:
